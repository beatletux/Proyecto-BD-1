                ...
                <div class="container-fluid">
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    ...
                                    <form  method="GET">
                                        <?php
                                            //pregunta para saber el pass y usuario del que acabamos de guardar
                                            $sql1 = "SELECT * FROM (SELECT SIGHTING.ID_PERSON FROM SIGHTING ORDER BY SIGHTING.ID_PERSON ) WHERE ROWNUM = 1";  
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <h2>PASSWORD ENCRIPTATION MD5-(128 BITS)</h2>
                            <div class="card">
                                <div class="card-header" data-background-color="orange">
                                ...
                                <div class="card-content table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        //pregunta para saber el pass y usuario del que acabamos de guardar
                                        $sql1 = "SELECT ID_SYSTEM_USER, USER_NAME, PASSWORD FROM SYSTEM_USER";  
